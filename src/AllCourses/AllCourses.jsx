...
const AllCourses = () => {
  ...
  let [JsCourse, setJsCOurse] = useState([
    {
      ...
      CourseInfo:
        "Become Zero-To-Hero in Javascript and start building Web-Applications",
      TutorPic: Bhavesh,
      ...
      coursesCard: [
        {
          ...
          CourseInfo:
            "Java Programming explained thorougly to enter beautiful world of Java",
          TutorPic: Adika,
      ...
      coursesCard: [
        {
          ...
          CourseInfo:
            "Complete Python Course loaded with various interesting Concepts",
          TutorPic: Vaishnavi,
  ...
  const getCourses = async () => {
    let { data } = await axios.get(
      "https://codigo-server.herokuapp.com/AllCourses/"
    );
      ...
      <div className="dashboard-navbar">
        ...
        <div id="courseSearch">
          ...
          <datalist id="AllCoursesList">
            ...
            <option value="Java Complete Course">
              Java Programming Series
            </option>
            <option value="Javascript Complete Course">
              JavaScript Development Series
            </option>
            <option value="Python Complete Course">
              Python Development Series
            </option>
            ...
            <option value="JavaScript Development Series">
              JavaScript Series
            </option>
            <option value="Python Development Series">
              Python Development
            </option>
          </datalist>
              ...
              return (
                <div className="OneSection">
                  ...
                  {eachObject.coursesCard.map((eachCard) => (
                    <CourseCard
                      shrtcourse={eachCard.shortCourseName}
                  ...
                  {eachObject.coursesCard
                    .filter((val) => {
                      if (searchTerm === "") {
                        ...
                        val.CourseName.toLowerCase().includes(
                          searchTerm.toLowerCase()
                        ) ||
                        val.TutorName.toLowerCase().includes(
                          searchTerm.toLowerCase()
                        ) ||
                        val.CourseInfo.toLowerCase().includes(
                          searchTerm.toLowerCase()
                        ) ||
                        val.SeriesName.toLowerCase().includes(
                          searchTerm.toLowerCase()
                        ) ||
                        val.keywords
                          .join(" ")
